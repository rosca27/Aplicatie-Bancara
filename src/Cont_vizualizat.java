...
public class Cont_vizualizat {

    JFrame frame7 = new JFrame("Informatii cont");
    ...
    JLabel sumaa = new JLabel("Suma din cont");
    JLabel ibant = new JLabel("IBAN");
    JButton exit = new JButton("Iesire");
    public Cont_vizualizat(String username, String parola, String ibann2){
        ...
        try{
            ...
            String query = "{call view_cont_info(?)}";
            CallableStatement stmt = connection.prepareCall(query);
            stmt.setString(1,ibann2);
            ...
            if(hasResults){
                ...
                while(rs.next()){
                    ...
                    tip_contt.setText(rs.getString(2));
                    ibann.setText(ibann2);
