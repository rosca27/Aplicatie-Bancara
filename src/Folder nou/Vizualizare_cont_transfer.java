...
public class Vizualizare_cont_transfer {
    JFrame frame6 = new JFrame("Transfer");
    DefaultListModel v = new DefaultListModel();
    JButton alegere = new JButton("Alege");
    JLabel alege = new JLabel("Alegeti Contul");
    JList lista_conturi = new JList(v);
    public Vizualizare_cont_transfer(String username, String parola){
        ...
        alegere.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                new Transfer(username, parola,ibann2);
                frame6.dispose();
            }
        });
    }
